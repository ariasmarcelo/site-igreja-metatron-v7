...
$logFile = 'C:\temp\Site_Igreja_Meta\V5_SiteIgreja\workspace\shadcn-ui\logs\deploy-20251110-050752.log'
...
Write-Log "Mensagem: test: alias -b para background"
...
try {
    ...
    $gitCommitOutput = git commit -m "test: alias -b para background" 2>&1 | Out-String
