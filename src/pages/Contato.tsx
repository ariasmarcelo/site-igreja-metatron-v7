...
export default function Contato() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FAF9F7] to-[#F5F3F0]">
      {/* Header */}
      <section className="py-20 bg-gradient-to-r from-[#60a5fa] via-[#2563eb] to-[#60a5fa] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="relative inline-block mb-6">
              <Mail className="w-[89px] h-[89px] mx-auto drop-shadow-lg text-[#CFAF5A]" style={{
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="mb-8 shadow-lg border-2 border-amber-200 bg-gradient-to-br from-amber-50/50 to-yellow-50/30">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card className="shadow-xl border-2 border-[#25D366]">
                <CardHeader className="bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white p-6">
                  <CardTitle className="flex items-center gap-3 text-[25px] leading-none">
                    <MessageCircle className="w-[30px] h-[30px] stroke-[2] m-[6px]" />
                ...
                <CardContent className="pt-6">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 text-[16px]">
                      <Mail className="w-5 h-5 text-[#4A90A9] flex-shrink-0" />
              ...
              <Card className="shadow-xl border-2 border-[#C0C4C7]">
                <CardHeader className="bg-gradient-to-r from-[#C0C4C7] to-[#9EA2A5] text-black p-6 relative overflow-hidden">
                  ...
                  <CardTitle className="flex items-center gap-3 text-[25px] leading-none relative z-10">
                    <Clock className="w-[32px] h-[32px] stroke-[2] m-[2px]" />
